    ...
    <div class="p-8">
      ...
      <form class="space-y-4 md:space-y-6" action="#">
        <div>
          ...
          <input v-model="staffId" name="staffId" id="staffId"
        ...
        <button @click="submitForm"
          class="bg-yellow hover:bg-yellow-50 w-full text-white font-bold py-2 px-4 rounded">Sign in</button>
        <span v-if="wrongMsg" class="text-red">Wrong Staff ID or password! Please re-enter your details. If you have any
          other issues, contact the administrator</span>
      </form>
    </div>
    <div class="p-0">
