...
<template>
  <div class="bg-beige px-10 py-5">
    <div class="flex items-center justify-between">
      ...
      <!-- Edit button -->
      <router-link v-if="hrRights" to="/edit-role-listing"
      ...
      <!-- Modal toggle -->
      <button class="bg-yellow text-white rounded-full px-4 py-2 flex items-center space-x-2" type="button"
        @click="openApply">
        Apply for Role
      </button>
      <!-- Main modal -->
            ...
            <form class="space-y-6 px-6 lg:px-8 pb-4 sm:pb-6 xl:pb-8" action="#">
              <div class="grid grid-cols-3 pt-5 gap-28">
                <div>
                  ...
                  <input type="text" class="mt-1 w-full p-2 bg-white border-2 border-yellow rounded-md"
                    v-model="managerID" />
                </div>
                <div>
